...
styles_categories = r"C:\Users\John Ayres\OneDrive - Enchante Living\Documents\01 - AIMS RAW DATA\1 - STYLES\Master.xlsx"
categories_reference = r"C:\Users\John Ayres\OneDrive - Enchante Living\Documents\01 - AIMS RAW DATA\1 - STYLES\Categories_Master.xlsx"
sty_files = r"C:\Users\John Ayres\OneDrive - Enchante Living\Documents\01 - AIMS RAW DATA\1 - STYLES\* - Style Report.xls"
bookings = r"C:\Users\John Ayres\OneDrive - Enchante Living\Documents\13 - BOOKINGS\Bookings Approvals_Master.xlsx"
opos_files = r"C:\Users\John Ayres\OneDrive - Enchante Living\Documents\01 - AIMS RAW DATA\3 - PURCHASE ORDERS\* - PO OR Comp Report.csv"
fopo_orders = r"C:\Users\John Ayres\OneDrive - Enchante Living\Documents\01 - AIMS RAW DATA\3 - PURCHASE ORDERS\* - FPO.xls"
shi_files = r"C:\Users\John Ayres\OneDrive - Enchante Living\Documents\01 - AIMS RAW DATA\4 - SHIPMENTS\* - PO Shipment Report.xls"
ord_files = r"C:\Users\John Ayres\OneDrive - Enchante Living\Documents\01 - AIMS RAW DATA\7 - SALES ORDERS\* - Open Order.csv"
vh_files = r"C:\Users\John Ayres\OneDrive - Enchante Living\Documents\01 - AIMS RAW DATA\6 - FACTORY ORDERS\* - Vendor Purchases Report.csv"
shipto = r"C:\Users\John Ayres\OneDrive - Enchante Living\Documents\25 - PO TRACKING\01 - WORKING\ShipTo.csv"
gc = r"C:\Users\John Ayres\OneDrive - Enchante Living\Documents\25 - PO TRACKING\Detailed-Tracking.xlsx"
mxn = r"C:\Users\John Ayres\OneDrive - Enchante Living\Documents\25 - PO TRACKING\Mexico Follow Up.xlsx"
wt = r"C:\Users\John Ayres\OneDrive - Enchante Living\Documents\25 - PO TRACKING\WebTracker - *.xls"
cbf = r"C:\Users\John Ayres\OneDrive - Enchante Living\Documents\05 - INVENTORY\01 - HISTORICAL\CBF.xlsx"
...
styles_data = st_master[["Database_Number", "Style", "Color", "Style_Description", "Color_Description", "AIMS_Division",
                         "PO_Cost", "In_Land_Cost", "Ocean_Freight_Cost", "Duty", "Tariff", "Other_Cost", "Total_Cost",
                         "Sales_Price",
...
pos_data = opos_master[
    ["Database_Number", "Style", "Color", "Vendor_Name", "PO_No", "PO_Qty", "PO_Date", "PO_Cancel", "Shipped_Qty",
     "Open_Qty", "FOB", "Shipment_No"]]
...
shi_master["ETD_Port"] = pd.to_datetime(
    (shi_master["shipment_date"]).astype("str").str.replace("  -   -", "01-Jan-1900"))
...
shipping_data = shi_master[
    ["Database_Number", "Style", "Color", "Shipment_No", "Document_No", "Container", "PO_No", "ETD_Port", "ETA_Port",
...
vendor_history_data = fty_master[
    ["Database_Number", "Style", "Color", "Group_Code", "Vendor", "Vendor_Name", "Account", "Account_Name", "PO_No",
...
styles_categories_data["ID"] = styles_categories_data["STYLE"].astype("str") + styles_categories_data["COLOR"].astype(
    "str")
categories = styles_categories_data[
    ["DATABASE_NUMBER", "DIVISION", "ID", "PRODUCT_CATEGORY", "PRODUCT_TYPE", "PRODUCT_STATUS"]]
...
styles_data = styles_data[
    ["ID", "Style", "Color", "Total_Cost", "Sales_Price", "Lenght CM", "Width CM", "Height CM", "CRTN CBM",
...
styles_master = styles_master[
    ["Division", "Category", "ID", "AIMS Database", "AIMS Division", "Style", "Color", "Type", "Status",
     "ELC", "Sales Price"]]
...
shipping_data["POID"] = shipping_data["ID"] + shipping_data["PO_No"].astype("str") + shipping_data[
    "Shipment_No"].astype("str")
...
coming_inventory = coming_inv[["ID", "POID", "Style", "Color", "PO_No", "PO_Date", "PO_Cancel", "Vendor_Name", "FOB",
                               "Shipment_No", "Document_No", "Container", "Qty", "ETD_Port", "ETA_Port", "ETA Whs",
                               "Week"]]
...
bound_in["Audit"] = bound_in["ID"] + bound_in["PO_No"].astype("str") + bound_in["Qty"].astype("str") + bound_in[
    "Container"].astype("str")
...
master.loc[:, "Delivery Port / Country"][
    (master.loc[:, "Vendor Port"] == "Kolkata, IN") & (master.loc[:, "Ship to Location"] == "FOB")] = "FOB Origin, IN"
...
master = master[["Division", "Category", "ID", "AIMS Database", "AIMS Division", "Style", "Color", "Type", "Status",
                 ...
                 "Casepack", "CRTNs", "CRTN CBM", "Total CBM", "Total CBF", "AIMS ETD Port", "AIMS ETA Port",
                 "Vendor Port",
...
master = master[["Style", "Color", "PO No", "Qty", "Ship to Location", "AIMS Location Code", "Main Customer",
                 ...
                 "Total CBM", "Total CBF", "AIMS ETD Port", "AIMS ETA Port", "Origin Port", "Delivery Port",
                 "Booking No",
                 "Import Container No", "Import ETD Port", "Import ETA Port", "Import ETA Whs", "WT Container(s)",
                 "WT Port ETD", "WT Port ETA", "Carrier Name", "Origin Departure Vessel Name", "Origin Port",
                 "Destination Port",
...
writer = pd.ExcelWriter(
    r"C:\Users\John Ayres\OneDrive - Enchante Living\Documents\25 - PO TRACKING\Inbound Shipment Report Working.xlsx",
    engine="xlsxwriter")
